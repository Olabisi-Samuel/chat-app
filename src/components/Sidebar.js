              ...
              {display ? (
                <>
                  {friend.map((person) => {
                    return (
                      <form
                        className="p-2 mx-3    rounded-md cusor-pointer hover:shadow-lg my-3"
                      ...
                      >
                        ...
                        />
                        <button
                          className="bg-rose-700 text-white px-2 py-1 rounded mt-1 hover:bg-white hover:text-rose-900"
                          type="submit"
                        >
                          Add Friend
                        </button>
                ...
                <>
                  {friends.map((fri) => {
                    return (
                      <button
                        className="p-2 mx-3   hover:bg-rose-900 rounded-md cusor-pointer hover:shadow-lg my-3 w-[90%]"
                        onClick={() => dispatch(setCurrentFriend(fri))}
                      >
